...
<template>
    ...
    <span @click="route_it(value.settlement_ID)" class="the_row" v-for="(value, index) in pagenated_table_data" :key="index">
        
    <tr  class="table_row" v-if="updated_button_value == value.category || updated_button_value == 'all'">                        
...
function route_it(settle_ID){
    if (settle_ID != null){
    transition_and_route('/user_dashboard/settlement_page/?settlement_ID=' + settle_ID)
    }
}
