...
const table_name = ref('Successful Settlements')
...
const message = ref('')
const active_page = {is_active: "successful_settlements"}
const result = ref('')
const csrf_cookie = useCookie('csrf_access_token')


  fetch(`${config.flask_url}/api/user_dashboard/successful_settlements/`, {
      method: 'post',
      mode: 'cors',
      credentials: 'include',
      headers: {
