<template>
        ...
        <CWSGSAPScrollSmoother>
            ...
            <div class="dashboard_inner_section" ref="el">
                <div class="main_content_container">
                  ...
                  <iframe v-if="rocket_chat_auth_token != null" ref="rc_iframe"   src="https://get.rocket.chat/"></iframe>

                    <h4 class="no_chats_message" v-else>No Open Chats</h4>
  ...
  const active_page = {is_active: "chat"}
