<template>
    ...
    <div style="background-color: #fff; padding-bottom:10%; border-bottom: 1px solid rgb(167, 211, 232, 0.4);">
      


    
<h2 class="inv_title">All Investments</h2>


        <div class="all_investments_container">


<div class="investment_container empty_container"></div>
...
<WALLSTREETScrubTextInvestments />
